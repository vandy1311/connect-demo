...
with tab_team:
    ...
    st.markdown(_step_card.format(
        ...
        body='Posted the tool in our CSM Slack channel and turned the build into a 3-part series on the <a href="https://www.linkedin.com/in/aws-c2sm/?skipRedirect=true" target="_blank" style="color:#3b82f6; text-decoration:none; font-weight:600;">AWS C2SM LinkedIn</a> so other CSMs could ship faster too.',
        extra="",
    ), unsafe_allow_html=True)
    st.html('<div style="display:grid; grid-template-columns:repeat(3, 1fr); gap:10px; margin-top:14px;"><a href="https://www.linkedin.com/posts/aws-c2sm_aidlc-agenticai-aws-ugcPost-7460805669726740480-eJeD/?utm_source=share&utm_medium=member_desktop&rcm=ACoAAAD5CCUBr2srzgr2QKY6Z0AX5CdodvFZtG0" target="_blank" style="text-decoration:none; color:inherit;"><div style="background:#0f172a; border:1px solid #334155; border-radius:10px; padding:12px; transition:border-color 0.2s; height:100%;"><div style="display:flex; align-items:center; gap:6px; margin-bottom:8px;"><svg width="14" height="14" viewBox="0 0 24 24" fill="#0a66c2"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.063 2.063 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg><span style="background:rgba(10,102,194,0.15); color:#0a66c2; font-size:0.65rem; font-weight:700; padding:2px 8px; border-radius:100px; letter-spacing:0.5px;">Part 1</span></div><div style="font-weight:700; color:#e2e8f0; font-size:0.82rem; line-height:1.35; margin-bottom:6px;">The playbook: AI-DLC from idea to spec</div><div style="color:#94a3b8; font-size:0.74rem; line-height:1.5;">Three women walked into a hackathon. Here\'s the framework we used to structure the build — AI-DLC — turning a Slack-channel question into a working spec.</div><div style="font-size:0.7rem; font-weight:600; margin-top:8px; color:#94a3b8;">Read on <span style="color:#0a66c2; text-decoration:underline; text-underline-offset:2px;">LinkedIn</span> →</div></div></a><a href="https://www.linkedin.com/posts/aws-c2sm_aidlc-agenticai-aws-ugcPost-7460811725563539457-C0Sw/?utm_source=share&utm_medium=member_desktop&rcm=ACoAAAD5CCUBr2srzgr2QKY6Z0AX5CdodvFZtG0" target="_blank" style="text-decoration:none; color:inherit;"><div style="background:#0f172a; border:1px solid #334155; border-radius:10px; padding:12px; transition:border-color 0.2s; height:100%;"><div style="display:flex; align-items:center; gap:6px; margin-bottom:8px;"><svg width="14" height="14" viewBox="0 0 24 24" fill="#0a66c2"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.063 2.063 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg><span style="background:rgba(10,102,194,0.15); color:#0a66c2; font-size:0.65rem; font-weight:700; padding:2px 8px; border-radius:100px; letter-spacing:0.5px;">Part 2</span></div><div style="font-weight:700; color:#e2e8f0; font-size:0.82rem; line-height:1.35; margin-bottom:6px;">The product: 20 min → 2 sec, $150K → $34/month</div><div style="color:#94a3b8; font-size:0.74rem; line-height:1.5;">Open the demo. Each query is a question a contact center supervisor couldn\'t answer yesterday — answered live in 2 seconds. Not a dashboard. A decision engine.</div><div style="font-size:0.7rem; font-weight:600; margin-top:8px; color:#94a3b8;">Read on <span style="color:#0a66c2; text-decoration:underline; text-underline-offset:2px;">LinkedIn</span> →</div></div></a><a href="https://www.linkedin.com/posts/aws-c2sm_buildinpublic-aidlc-agenticai-ugcPost-7460815102972174336-gM8z/?utm_source=share&utm_medium=member_desktop&rcm=ACoAAAD5CCUBr2srzgr2QKY6Z0AX5CdodvFZtG0" target="_blank" style="text-decoration:none; color:inherit;"><div style="background:#0f172a; border:1px solid #334155; border-radius:10px; padding:12px; transition:border-color 0.2s; height:100%;"><div style="display:flex; align-items:center; gap:6px; margin-bottom:8px;"><svg width="14" height="14" viewBox="0 0 24 24" fill="#0a66c2"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.063 2.063 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg><span style="background:rgba(10,102,194,0.15); color:#0a66c2; font-size:0.65rem; font-weight:700; padding:2px 8px; border-radius:100px; letter-spacing:0.5px;">Part 3</span></div><div style="font-weight:700; color:#e2e8f0; font-size:0.82rem; line-height:1.35; margin-bottom:6px;">Build in public: AI-DLC + agentic AI</div><div style="color:#94a3b8; font-size:0.74rem; line-height:1.5;">What we shipped, what broke, and why every architecture decision had a one-sentence reason behind it. AI accelerated us. It didn\'t replace us.</div><div style="font-size:0.7rem; font-weight:600; margin-top:8px; color:#94a3b8;">Read on <span style="color:#0a66c2; text-decoration:underline; text-underline-offset:2px;">LinkedIn</span> →</div></div></a></div>')
